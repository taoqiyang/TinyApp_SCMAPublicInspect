  ...
  chooseConsultOrComplain: function () {
    ...
    wx.showActionSheet({
      ...
      success: function (res) {
        if(res.tapIndex >= 0){
          wx.navigateTo({
            url: '../rec/report/consultOrComplain?title=' + itemList[res.tapIndex] + '&reportTypeID=' + (res.tapIndex + 2),
          })
        }
      }
    })
